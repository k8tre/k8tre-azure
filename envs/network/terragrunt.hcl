...
inputs = {
  ...
  app_gateway_ssl_certificate_filename = include.root.locals.app_gateway_ssl_certificate_filename
  app_gateway_ssl_certificate_passphrase = include.root.locals.app_gateway_ssl_certificate_passphrase
