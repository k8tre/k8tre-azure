...
inputs = {
  ...
  cluster_subscription_id = include.root.locals.azure_k8tre_stg_cluster_subscription_id
  ...
  cluster_domain_name = "stg.k8tre.internal"
  ...
  lz_hub_vnet_resource_group_name = include.root.locals.lz_hub_v
