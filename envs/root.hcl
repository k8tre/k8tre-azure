locals {
    ...
    # Resources must be defined before mgmt cluster deployment
    argocd_admin_password                            = "testtesttest" # Note: Do not hardcode this, set via environment variable
    entra_admin_group_id                             = "8495e6fa-3c66-403b-abfe-227062b5d9d0"
    # argo_entra_application_id                        = "28632e6f-5642-4a6b-b18e-361f2af4e83e"


    # infra-network
    internal_dns_zone_name                           = "k8tre.internal"
    public_dns_zone_name                             = "karectl.dev"
