...
dependencies {
  paths = ["../cluster", "../internal-gateway"]
}
...
inputs = {
  ...
  resource_group_name = dependency.env_cluster.outputs.resource_group_name
  fq_cluster_name = dependency.env_cluster.outputs.fq_cluster_name
  client_certificate = dependency.env_cluster.outputs.client_certificate
  client_key = dependency.env_cluster.outputs.client_key
  
  # Entra Argo Integration
  ...
  #argo_entra_application_id = include.root.locals.argo_entra_application_id
