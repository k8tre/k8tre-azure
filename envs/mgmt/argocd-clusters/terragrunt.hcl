...
dependency "prd_cluster" {
 config_path = "../../prd/cluster"
 mock_outputs = {
...
inputs = {
  ...
  prd_kube_host = dependency.prd_cluster.outputs.kube_host
  prd_cluster_ca_certificate = dependency.prd_cluster.outputs.cluster_ca_certificate
  ...
  azure_k8tre_prd_cluster_subscription_id = include.root.locals.azure_k8tre_prd_cluster_subscription_id
